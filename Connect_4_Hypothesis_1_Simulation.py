...
if not os.path.exists("Connect4 Board.txt"):
    f1=open("Connect4 Board.txt","w")
else:
    f1=open("Connect4 Board.txt","a")
...
for i in range(2):#### PLAYS SIMULATION TWICE
    ...
    #############################################################################
        ...
        if not os.path.exists("connect4 hypothesis 1.csv"):
            print("file doesnt exist, creating new file.")
            f = open('connect4 hypothesis 1.csv', mode='w', newline='')
            write = csv.writer(f)
            write.writerow(data)
            write.writerow(row)
        else:
            f = open('connect4 hypothesis 1.csv', mode='a', newline='')
            write = csv.writer(f)   
            write.writerow(row)
        
    print("")
    print("Connect 4 simulation, Hypothesis 1 (only playing in centre columns)")
    print(p1,"moves = ",m)
    print("draws :", dr )
    print(p1,"wins = ", pw)
    print(cname, "wins = ", cw)
